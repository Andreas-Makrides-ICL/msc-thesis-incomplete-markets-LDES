...
function run_ADMM(data, setup, solver, delta)
    ...
    if termination_status(m.model) == MOI.OPTIMAL
        ...
        filename = "H2_15000_04_agent_objective_breakdown_delta_$(round(delta, digits=2)).txt"
        str = "H2_15000_04"
...
CSV.write("H2_15000_04_ADMM_risk_aversion_results_O30_T672_new_final.csv", df)
