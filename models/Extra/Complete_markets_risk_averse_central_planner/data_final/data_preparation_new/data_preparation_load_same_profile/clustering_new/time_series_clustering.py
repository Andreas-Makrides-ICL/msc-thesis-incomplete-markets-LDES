...
def process_scenarios(scenarios, n_reduced=672):
    ...
    """
    # Load data
    data_load = pd.read_csv(r"C:\Users\user\Desktop\msc-thesis-incomplete-markets-LDES\models\Extra\Complete_markets_risk_averse_central_planner\data_final\data_preparation_new\data_preparation_load_same_profile\clustering_new\sampled_normalized_data_40_same_load_profile.csv")
    data_cf = pd.read_csv(r"C:\Users\user\Desktop\msc-thesis-incomplete-markets-LDES\models\Extra\Complete_markets_risk_averse_central_planner\data_final\data_preparation_new\data_preparation_load_same_profile\clustering_new\data_VRE_final.csv")
    ...
    folder = r"C:\Users\user\Desktop\msc-thesis-incomplete-markets-LDES\models\Extra\Complete_markets_risk_averse_central_planner\data_final\data_preparation_new\data_preparation_load_same_profile\clustering_new\clustered_data"
