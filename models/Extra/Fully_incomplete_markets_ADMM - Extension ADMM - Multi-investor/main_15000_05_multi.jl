...
function run_ADMM(data, setup, solver, delta)
    ...
    if termination_status(m.model) == MOI.OPTIMAL
        ...
        filename = "mulitinvestor_05_agent_objective_breakdown_delta_$(round(delta, digits=2)).txt"
        str = "mulitinvestor_05"
...
CSV.write("multinvestor_05_ADMM_risk_aversion_results_O30_T672_new_final.csv", df)
