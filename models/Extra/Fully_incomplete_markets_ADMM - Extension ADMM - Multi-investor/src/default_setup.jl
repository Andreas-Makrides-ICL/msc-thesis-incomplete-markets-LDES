...
const default_setup = Dict(
    ...
    # New investor mapping
    "participants" => [
        "invpv",  # Single-tech investor for PV
        "invonshore",  # Single-tech investor for WindOnhore
        "invoffshore",  # Single-tech investor for WindOffhore
        "invgas",  # Single-tech investor for gas
        "invnuclear",  # Single-tech investor for nuclear
        "invldes", # Single-tech investor for LDES
        "invbess", # Single-tech investor for BESS
        "multi",  # New multi-investor
    ],

    # Tech assignments per investor
    "investor_tech_map" => Dict(
        "invpv" => ["PV"],
