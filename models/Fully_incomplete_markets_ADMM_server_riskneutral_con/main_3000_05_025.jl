...
function run_ADMM(data, setup, solver, delta)
    ...
    if termination_status(m.model) == MOI.OPTIMAL
        ...
        filename = "H2_3000_05_025_agent_objective_breakdown_delta_$(round(delta, digits=2)).txt"
        str = "H2_3000_05_025"
...
CSV.write("H2_3000_05_025_ADMM_risk_aversion_results_O30_T672_new_final.csv", df)
