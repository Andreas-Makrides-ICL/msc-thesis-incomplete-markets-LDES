...
function run_ADMM(data, setup, solver, delta)
    ...
    if termination_status(m.model) == MOI.OPTIMAL
        ...
        filename = "gasprice_1_75_agent_objective_breakdown_delta_$(round(delta, digits=2)).txt"
        str = "gasprice_1_75"
...
CSV.write("gasprice_1_75_ADMM_risk_aversion_results_O30_T672_new_final_unserved_fix_flex_gaspricescaled_cinvEldescheap_conwind.csv", df)
