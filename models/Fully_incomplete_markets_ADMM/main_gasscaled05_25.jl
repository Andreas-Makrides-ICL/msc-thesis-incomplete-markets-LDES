...
function run_ADMM(data, setup, solver, delta)
    ...
    if termination_status(m.model) == MOI.OPTIMAL
        ...
        filename = "gasscaled05_25_agent_objective_breakdown_delta_$(round(delta, digits=2)).txt"
        str = "gasscaled05_25"
...
CSV.write("gasscaled05_25_ADMM_risk_aversion_results_O30_T672_new_final_unserved_fix_flex_gaspricescaled_cinvEldescheap_conwind.csv", df)
